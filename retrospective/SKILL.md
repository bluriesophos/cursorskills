---
name: retrospective
description: After completing a significant task or experiment, documents what worked, what failed, and key learnings. Failed attempts get documented first - they're read more than successes. Use when a multi-step task finishes or when the user says "done", "finished", or asks for a summary.
---
