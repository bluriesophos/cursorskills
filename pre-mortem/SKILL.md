...
The common failure mode is the opposite - jumping to implementation, discovering
problems mid-way, patching reactively. This skill encodes prospective hindsight:
imagine failure, then prevent it.
...
### Example 2: Minor Task (Pre-mortem Not Needed)
