---
name: keep-it-simple
description: Before adding abstraction, asks "do we need this now?" Activates when proposing factories, abstract classes, config-driven behavior, or "for future extensibility." Resists over-engineering. Use when the agent is about to build something more complex than what was asked for.
---
...
AI assistants love elegant abstractions. User asks for a button, the agent builds a
